    ...
    Tables: {
      ...
      user_stats: {
        Row: {
          ...
          no_reels_streak: number;
          no_masturbation_streak: number;
          full_discipline_streak: number;
          best_focus_streak: number;
          best_prayer_streak: number;
          best_no_reels_streak: number;
          best_full_discipline_streak: number;
          updated_at: string;
        };
        Insert: {
          user_id: string;
